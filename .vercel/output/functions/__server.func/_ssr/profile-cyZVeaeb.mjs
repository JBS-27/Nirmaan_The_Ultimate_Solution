...
import { u as mapProfile } from "./map-TuuXPdmi.mjs";
import { t as ensureCatalog } from "./seed-OVWykS8x.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/profile-cyZVeaeb.js
...
var getMyProfile = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(getMyProfile_createServerFn_handler, async ({ context }) => {
	...
	let name = "Builder";
	try {
		const { getSessionUser } = await import("./verify.server-B2qfSong.mjs");
