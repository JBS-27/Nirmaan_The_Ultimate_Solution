...
import { n as PublicHeader } from "./public-header-CwwwxEA3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BjwGFPtv.js
var import_jsx_runtime = require_jsx_runtime();
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bg-bg text-ink",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PublicHeader, { active: "home" }),
